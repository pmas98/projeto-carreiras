...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.43 (foreground color: #317b4e, background color: #18181b, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.43 (foreground color: #317b4e, background color: #18181b, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.5 (foreground color: #8e4748, background color: #231c1f, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.5 (foreground color: #8e4748, background color: #231c1f, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.82 (foreground color: #8f582d, background color: #231e1d, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.82 (foreground color: #8f582d, background color: #231e1d, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
  ...
  - generic [ref=e4]:
    ...
    - main [ref=e15]:
      - generic [ref=e16]:
        ...
        - dialog "Ajustar HTML" [ref=e111]:
          - generic [ref=e112]: "Passo 1 de 2: Ajustar HTML"
          - generic [ref=e113]:
            - generic [ref=e114]:
              - generic [ref=e115]: Passo 1 de 2
              - heading "Ajustar HTML" [level=3] [ref=e116]
            - generic [ref=e117]:
              - generic [ref=e118]:
                - paragraph [ref=e119]: Instrucao
                - paragraph [ref=e120]: Corrija a semântica
              - generic [ref=e121]:
                - paragraph [ref=e122]: Por que isso importa
                - paragraph [ref=e123]: Troque elementos genéricos por tags adequadas para interação.
            - generic [ref=e124]:
              - button "Pular" [active] [ref=e125]
              - generic [ref=e126]:
                - button "Voltar" [disabled] [ref=e127]
                - button "Proximo" [ref=e128]
  - alert [ref=e129]
```
